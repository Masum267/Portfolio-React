            ...
            <footer className="bg-gradient-to-b from-black to-gray-800">
                <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <img src={Logo} className="mr-5 h-8 sm:h-9" alt="logo" />
                            <p className="max-w-xs mt-4 text-sm text-gray-400">
                            Passionate Frontend Engineer who Proves skill rather than showing skills. A developer who tries to provide a simple and bugless code. A learner with fast learning skills and lots of patience in learning new things.
                            </p>
                    ...
                    <p className="mt-8 text-xs text-slate-100">
                        © 2023 Abdullah Al Masum
                    </p>
                </div>
            </footer>
        </>
