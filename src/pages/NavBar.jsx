...
function NavBar() {
    ...
    return (
        <>
            ...
            h-20 text-white fixed bg-slate-700 px-4">
                <div>
                    <h1 className="text-md font-sans"> Abdullah Al Masum</h1>
                </div>
                ...
                <ul className="hidden md:flex">
                    ...
                    {links.map(({ id, link }) => (
                        ...
                        font-medium text-slate-50 hover:scale-105 duration-200"
                        >
                ...
                <div
                    onClick={() => setNav(!nav)}
                    className="cursor-pointer pr-4 z-10 text-gray-100
                    md:hidden" 
                >
